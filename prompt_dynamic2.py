...
page=st.sidebar.radio("Select one anomg the following:",["Page Configration","Science","English","Math","Social Science"])
if page=="Page Configration":
    st.title("Question-Answering System")
    image=Image.open("C:\\Users\\Dell\\Downloads\\QA.png") 
    st.image(image,use_container_width=True)
elif page=="Science":
    st.header("Science Question-Answering System")
    explanation_layout=st.selectbox("Select Explanation level:",["select","Begineer","Intermediate","Advanced"])
